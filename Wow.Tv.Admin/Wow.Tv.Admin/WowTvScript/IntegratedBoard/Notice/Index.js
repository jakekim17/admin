...
var NoticeIndex = {
    ...
    GoEdit: function (seq) {
        $("#seq").val(seq);
        $("#frmSearch").attr("method", "POST");
        $("#frmSearch").attr("action", "/IntegratedBoard/Notice/Edit?menuSeq=" + $('#CurrentMenuSeq').val());
        $("#frmSearch").submit();
    ...
    GoAdd: function (currentIndex) {
        $("#currentIndex").val(currentIndex);
        $("#frmSearch").attr("method", "POST");
        $("#frmSearch").attr("action", "/IntegratedBoard/Notice/Add?menuSeq=" + $('#CurrentMenuSeq').val());
        $("#frmSearch").submit();
    ...
    RemoveAll: function (items) {
        $.ajax({
            type: "POST",
            url: "/IntegratedBoard/Notice/RemoveAll?menuSeq=" + $('#CurrentMenuSeq').val(),
            data: { "items": items },
