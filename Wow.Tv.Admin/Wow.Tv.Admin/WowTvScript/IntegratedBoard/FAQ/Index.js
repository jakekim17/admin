...
var FAQIndex = {
    ...
    GoEdit: function (seq) {
        $("#seq").val(seq);
        $("#frmSearch").attr("method", "POST");
        $("#frmSearch").attr("action", "/IntegratedBoard/FAQ/Edit?menuSeq=" + $('#CurrentMenuSeq').val());
        $("#frmSearch").submit();
    ...
    GoAdd: function (currentIndex) {
        $("#currentIndex").val(currentIndex);
        $("#frmSearch").attr("method", "POST");
        $("#frmSearch").attr("action", "/IntegratedBoard/FAQ/Add?menuSeq=" + $('#CurrentMenuSeq').val());
        $("#frmSearch").submit();
    ...
    RemoveAll: function (items) {
        $.ajax({
            type: "POST",
            url: "/IntegratedBoard/FAQ/RemoveAll?menuSeq=" + $('#CurrentMenuSeq').val(),
            data: { "items": items },
