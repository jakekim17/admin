    ...
    function html5Upload() {	
        ...
        sUploadURL = '/Upload/EditorFileUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
            sUrl: '/Upload/EditorFileUpload',	 //URL
 	        sCallback : '/callback.html',	//업로드 이후 콜백페이지의 주소
...
// 	    		oCustomEvent.stop(); 수행시 bAllowed 가 false이더라도 alert이 수행되지 않음
              ...
              success: function (oCustomEvent) {
                ...
                aResult[0].sFileURL = decodeURIComponent(aResult[0].sFileURL);
                setPhotoToEditor(aResult);
                //버튼 비활성화
                goReadyMode();
                oFileUploader.reset();
    ...
    window.onload = function () {
        /* 주석처리 시 HTML방식만 사용한다. 
            pop_container : HTML5 드래그앤드롭 방식이다.
        */
  		//checkDragAndDropAPI();
