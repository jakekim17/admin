...
var NewsLandEntspo = {
    ...
    ConfigList: function (currentIndex) {
        ...
        if ($("#SearchGubun").val() == "") {
            ...
            $.ajax({
                type: "POST",
                url: "NewsLandEntspoConfigList?menuSeq=" + currentMenuSeq,
                data: $("#frmSearch").serialize(),
                success: function (data, textStatus) {
    ...
    List: function (currentIndex) {
        ...
        if ($("#SearchGubun").val() == "") {
            ...
            $.ajax({
                type: "POST",
                url: "NewsLandEntspoList?menuSeq=" + currentMenuSeq,
                data: $("#frmSearch").serialize(),
                success: function (data, textStatus) {

                    $("#tbodyNewsList").html(data);
                    NewsLandEntspo.ListPagingHtml(currentIndex);
                }
            });
        }
    },
    ...
    ListPagingHtml: function (currentIndex) {
        ...
        if (totalDataCount == 0) {
            ...
            $("#divPaging").html(cfGetPagingHtml(totalDataCount, currentIndex, pageSize, "NewsLandEntspo.List"));
        }
    }
}
