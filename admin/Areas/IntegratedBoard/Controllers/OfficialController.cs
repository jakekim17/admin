...
{
    /// <summary>
    /// <para> 통합게시판-공고형 템플릿 Controller</para>
    ...
    /// </summary>
    /// <remarks>통합게시판-공고형 템플릿 CRUD</remarks>
    [WowTvAdminAuthorize(IsRead = true)]
    public sealed class OfficialController : BaseController
    {
        ...
        public ActionResult FileSave(NTB_BOARD_CONTENT board, IEnumerable<HttpPostedFileBase> files )
        {
            ...
            uploadFilePath = uploadFilePath + "/IntegratedBoard/Official/";
            uploadWebPath = uploadWebPath + "/IntegratedBoard/Official/";
        ...
        [ValidateInput(false)]
        [WowTvAdminAuthorize(IsWrite = true)]
        public ActionResult FileUpdate(NTB_BOARD_CONTENT board, List<int> deleteFiles, IEnumerable<HttpPostedFileBase> files)
        {
            string msg = "";
            bool isSuccess = true;
