...
namespace Wow.Tv.Admin.Controllers
{
    public class MigrationController : Controller
    {
        ...
        public ActionResult ProgramMenuMigration()
        {
            //var newsProgramService = new BroadService.NewsProgramServiceClient();

            //var list = newsProgramService.GetMigrationProgramList();
            //foreach (var item in list)
            //{
            //    string programCode = item.PRG_CD;
        ...
        public ActionResult ProgramCornerMigration()
        {
            //var newsProgramService = new BroadService.NewsProgramServiceClient();
            ...
            //foreach (var item in list)
            //{
            //    newsProgramService.MigrationProgramCornerList(item.PRG_CD, LoginHandler.CurrentLoginUser);
            //}
